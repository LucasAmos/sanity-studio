    ...
    <Container width={1}>
      <Card padding={5} shadow={3} radius={3} marginY={5}>
        <Flex align="center" direction="column" gap={5} marginY={4}>
          ...
          <Stack space={4}>
            <Text muted>
              This is an example component 2, rendered with Sanity UI and the{" "}
            ...
            <Text muted>
              You can also replace this component with components of your own.
              Render them in your app by importing and using them in your
              application’s <code>src/App.tsx|jsx</code> file.
            </Text>
            <Text muted>
              Looking for more guidance? See the{" "}
              <a href="https://sanity.io/ui">Sanity UI docs</a> and the{" "}
